...
אנו מגדירים יחד סדרי עדיפויות מוסכמים בין מגוון המטרות —
מה חשוב יותר, מה דחוף יותר ומה ניתן לדחות.
המטרה היא
<strong> לייצר בחירה מודעת, ולא ויתור כפוי </strong>
גם כאשר קיימים אילוצים ומשאבים מוגבלים לאורך הדרך.

בשלב זה אנו בוחנים גם את
...
ומה המשמעות שלהם ביחס למטרות החיים שהוגדרו בשלב הקודם. איסוף המידע מתבצע בצורה מסודרת ומובנית, תוך הבחנה בין נתונים רלוונטיים לקבלת החלטות עתידיות
לבין מידע שאינו משפיע על התכנון עצמו. כך נמנעת בירוקרטיה מיותרת, והפוקוס נשמר על מה שחשוב באמת. בשלב זה אנו בונים תמונת מצב מלאה ועדכנית, המאפשרת להבין את 
...
כך שאין פער בין קבלת ההחלטות לבין היישום בפועל.
